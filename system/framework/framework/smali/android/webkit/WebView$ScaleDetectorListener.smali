...
.method public onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$1500(Landroid/webkit/WebView;)F
    ...
    invoke-static {v1, v6}, Landroid/webkit/WebView;->access$2602(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v1, v2}, Landroid/webkit/WebView;->access$2802(Landroid/webkit/WebView;F)F
    ...
    invoke-static {v1, v2}, Landroid/webkit/WebView;->access$3102(Landroid/webkit/WebView;F)F

    .line 5206
    iget-object v1, p0, Landroid/webkit/WebView$ScaleDetectorListener;->this$0:Landroid/webkit/WebView;

    invoke-static {v1, v0, v5, v5}, Landroid/webkit/WebView;->access$1600(Landroid/webkit/WebView;FZZ)V
...
.method public onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$2300(Landroid/webkit/WebView;)V
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$2400(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$2500(Landroid/webkit/WebView;)Landroid/webkit/WebTextView;
...
.method public onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    invoke-static {v1}, Landroid/webkit/WebView;->access$2600(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v1, v8}, Landroid/webkit/WebView;->access$2602(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$2800(Landroid/webkit/WebView;)F
    ...
    invoke-static {v4}, Landroid/webkit/WebView;->access$2900(Landroid/webkit/WebView;)I
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$3100(Landroid/webkit/WebView;)F
    ...
    invoke-static {v4}, Landroid/webkit/WebView;->access$3200(Landroid/webkit/WebView;)I
    ...
    invoke-static {v1, v2, v0, v7}, Landroid/webkit/WebView;->access$1600(Landroid/webkit/WebView;FZZ)V
    ...
    invoke-static {v1}, Landroid/webkit/WebView;->access$2400(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v1, v8}, Landroid/webkit/WebView;->access$3500(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v1}, Landroid/webkit/WebView;->access$2500(Landroid/webkit/WebView;)Landroid/webkit/WebTextView;
    ...
    invoke-static {v1, v2}, Landroid/webkit/WebView;->access$3602(Landroid/webkit/WebView;I)I

    .line 5186
    iget-object v1, p0, Landroid/webkit/WebView$ScaleDetectorListener;->this$0:Landroid/webkit/WebView;

    invoke-static {v1, v7}, Landroid/webkit/WebView;->access$3702(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v4}, Landroid/webkit/WebView;->access$3800(Landroid/webkit/WebView;)J

    move-result-wide v4

    invoke-static {v1, v2, v3, v4, v5}, Landroid/webkit/WebView;->access$3900(Landroid/webkit/WebView;FFJ)V
