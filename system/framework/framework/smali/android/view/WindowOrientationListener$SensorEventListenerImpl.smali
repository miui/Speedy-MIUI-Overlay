...
.method private calculateNewRotation(FF)V
    ...
    .line 310
    iget-boolean v5, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mAllow180Rotation:Z

    if-nez v5, :cond_0

    invoke-static {}, Landroid/view/WindowOrientationListener;->access$000()Landroid/content/Context;
    ...
    const-string v6, "accelerometer_rotate_180"
    ...
    .end local v0           #allow180Rotation:Z
    .end local v1           #i:I
    .end local v3           #row:I
    ...
    .line 313
    .restart local v0       #allow180Rotation:Z
    :cond_4
