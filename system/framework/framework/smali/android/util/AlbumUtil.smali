.class public Landroid/util/AlbumUtil;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 35
    iput-object p1, p0, Landroid/util/AlbumUtil;->mContext:Landroid/content/Context;

    .line 36
    iput p2, p0, Landroid/util/AlbumUtil;->mAlbumShadowHeight:I
    ...
    iput-object v0, p0, Landroid/util/AlbumUtil;->mRotateMatrix:Landroid/graphics/Matrix;

    .line 39
    iget-object v0, p0, Landroid/util/AlbumUtil;->mRotateMatrix:Landroid/graphics/Matrix;
    ...
    .line 40
    iput v2, p0, Landroid/util/AlbumUtil;->mAspectRatio:F
...
.method public cutToDefauleAspectRadio(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 51
    invoke-direct {p0, p1}, Landroid/util/AlbumUtil;->getAspectRadio(Landroid/graphics/Bitmap;)F

    move-result v7

    .line 52
    .local v7, radio:F
    iget v0, p0, Landroid/util/AlbumUtil;->mAspectRatio:F
    ...
    iget v2, p0, Landroid/util/AlbumUtil;->mAspectRatio:F
...
.method public getAlbumBitmap(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    iget-object v7, p0, Landroid/util/AlbumUtil;->mContext:Landroid/content/Context;
...
.method public getAlbumShadow(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 88
    iget v4, p0, Landroid/util/AlbumUtil;->mAlbumShadowHeight:I

    .line 89
    .local v4, scaledHeight:I
    iget v0, p0, Landroid/util/AlbumUtil;->mAlbumShadowHeight:I
    ...
    iget-object v5, p0, Landroid/util/AlbumUtil;->mRotateMatrix:Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0, v8, v0}, Landroid/util/AlbumUtil;->setAlpha(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public setAspectRadio(F)V
    ...
    .prologue
    .line 48
    iput p1, p0, Landroid/util/AlbumUtil;->mAspectRatio:F
