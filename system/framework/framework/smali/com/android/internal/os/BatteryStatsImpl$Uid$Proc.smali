...
.field private mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;
...
# direct methods
.method constructor <init>(Lcom/android/internal/os/BatteryStatsImpl$Uid;Lcom/android/internal/os/BatteryStatsImpl$Uid;)V
    .locals 1
    .parameter
    .parameter "uid"
    ...
    .line 3417
    iput-object p2, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;
...
.method public addCpuTimeLocked(II)V
    ...
    .prologue
    .line 3586
    iget-wide v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUserTime:J

    int-to-long v3, p1

    add-long/2addr v1, v3

    iput-wide v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUserTime:J

    .line 3587
    iget-wide v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mSystemTime:J

    int-to-long v3, p2

    add-long/2addr v1, v3

    iput-wide v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mSystemTime:J

    .line 3588
    iget-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;

    invoke-virtual {v1}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->getCpuUsageHistoryTimeline()Landroid/os/IHistoryValueTimeline;

    move-result-object v0

    check-cast v0, Lcom/android/internal/os/BatteryStatsImpl$CpuUsageHistoryTimeline;

    .line 3589
    .local v0, timeline:Lcom/android/internal/os/BatteryStatsImpl$CpuUsageHistoryTimeline;
    int-to-long v1, p1
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/internal/os/BatteryStatsImpl$CpuUsageHistoryTimeline;->addHistoryRecord(JJJ)V
...
.method public getUid()Lcom/android/internal/os/BatteryStatsImpl$Uid;
    .locals 1

    .prologue
    .line 3582
    iget-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;
...
.method readFromParcelLocked(Landroid/os/Parcel;)V
    ...
    iput-wide v3, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mVSS:J
    ...
    iput-wide v3, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mRSS:J
...
.method public setMemoryLocked(JJ)V
    .locals 7
    .parameter "vss"
    .parameter "rss"
    ...
    .prologue
    .line 3593
    iput-wide p1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mVSS:J

    .line 3594
    iput-wide p3, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mRSS:J

    .line 3595
    iget-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;

    invoke-virtual {v1}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->getMemUsageHistoryTimeline()Landroid/os/IHistoryValueTimeline;

    move-result-object v0

    check-cast v0, Lcom/android/internal/os/BatteryStatsImpl$MemUsageHistoryTimeline;

    .line 3596
    .local v0, timeline:Lcom/android/internal/os/BatteryStatsImpl$MemUsageHistoryTimeline;
    const-wide/16 v1, 0x0

    iget-object v3, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mUid:Lcom/android/internal/os/BatteryStatsImpl$Uid;

    invoke-virtual {v3}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->computeMemUsed()J
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/internal/os/BatteryStatsImpl$MemUsageHistoryTimeline;->addHistoryRecord(JJJ)V
...
.method writeToParcelLocked(Landroid/os/Parcel;)V
    ...
    .line 3518
    iget-wide v2, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mVSS:J

    invoke-virtual {p1, v2, v3}, Landroid/os/Parcel;->writeLong(J)V

    .line 3519
    iget-wide v2, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->mRSS:J
