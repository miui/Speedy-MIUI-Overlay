...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;,
        Lcom/android/internal/os/BatteryStatsImpl$MemUsageHistoryTimeline;,
        Lcom/android/internal/os/BatteryStatsImpl$MemUsageHistoryItem;,
        Lcom/android/internal/os/BatteryStatsImpl$CpuUsageHistoryTimeline;,
...
.field private final mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;
...
.field private final mTimeline:Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;-><init>(Lcom/android/internal/os/BatteryStatsImpl;)V

    iput-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mTimeline:Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;
    ...
    iput-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    .line 288
    iget-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mTimeline:Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;

    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->getCurHistory()Landroid/os/BatteryStats$HistoryItem;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    .line 286
    new-instance v1, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;

    invoke-direct {v1, p0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;-><init>(Lcom/android/internal/os/BatteryStatsImpl;)V

    iput-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl;->mTimeline:Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;

    .line 287
    new-instance v1, Lcom/android/internal/os/CommonHistoryTimeline;

    invoke-direct {v1}, Lcom/android/internal/os/CommonHistoryTimeline;-><init>()V

    iput-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    .line 288
    iget-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl;->mTimeline:Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;

    invoke-virtual {v1}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->getCurHistory()Landroid/os/BatteryStats$HistoryItem;
...
.method addHistoryRecordLocked(J)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->addHistoryRecordLocked(J)V
...
.method addHistoryRecordLocked(JB)V
    ...
    invoke-static {v0, v1, v2, p3}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->access$100(Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;JB)V
...
.method clearHistoryLocked()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->clearHistoryLocked()V

    .line 1191
    iget-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    invoke-virtual {v0}, Lcom/android/internal/os/CommonHistoryTimeline;->reset()V
...
.method public getBatteryCurrentHistory()Landroid/os/IHistoryValueTimeline;
    .locals 1
...
.method public getHistory()Landroid/os/BatteryStats$HistoryItem;
    ...
    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->getHistory()Landroid/os/BatteryStats$HistoryItem;
...
.method public getNextHistoryLocked(Landroid/os/BatteryStats$HistoryItem;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->getNextHistoryLocked(Landroid/os/BatteryStats$HistoryItem;)Z
...
.method readHistory(Landroid/os/Parcel;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->readHistory(Landroid/os/Parcel;)V

    .line 5022
    iget-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    invoke-virtual {v0, p1}, Lcom/android/internal/os/CommonHistoryTimeline;->readHistory(Landroid/os/Parcel;)V
...
.method public setBatteryState(IIIIII)V
    ...
    :goto_0
    iget-object v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistoryCur:Landroid/os/BatteryStats$HistoryItem;

    iget-byte v9, v11, Landroid/os/BatteryStats$HistoryItem;->batteryStatus:B

    .line 4482
    .local v9, oldStatus:I
    iget-boolean v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHaveBatteryLevel:Z
    ...
    iput-boolean v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHaveBatteryLevel:Z
    ...
    iget v12, v11, Landroid/os/BatteryStats$HistoryItem;->states:I

    const v13, -0x40000001

    and-int/2addr v12, v13

    iput v12, v11, Landroid/os/BatteryStats$HistoryItem;->states:I
    ...
    iput-boolean v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mRecordingHistory:Z
    ...
    iput-byte v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryLevel:B
    ...
    iput-byte v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryStatus:B
    ...
    iput-byte v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryHealth:B
    ...
    iput-byte v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryPlugType:B
    ...
    iput-char v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryTemperature:C
    ...
    iput-char v12, v11, Landroid/os/BatteryStats$HistoryItem;->batteryVoltage:C
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/os/BatteryStatsImpl;->setOnBattery(ZII)V
    ...
    iget-byte v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryLevel:B
    ...
    iget-byte v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryStatus:B
    ...
    iget-byte v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryHealth:B
    ...
    iget-byte v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryPlugType:B
    ...
    iget-char v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryTemperature:C
    ...
    iget-char v11, v11, Landroid/os/BatteryStats$HistoryItem;->batteryVoltage:C
    ...
    iget-boolean v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mRecordingHistory:Z
    ...
    invoke-virtual {p0, v11, v12}, Lcom/android/internal/os/BatteryStatsImpl;->addHistoryRecordLocked(J)V
    ...
    invoke-virtual {v11}, Lcom/android/internal/util/CurrentReader;->read()J

    move-result-wide v5

    .line 4544
    .local v5, currentNow:J
    const v8, 0xea60

    .line 4545
    .local v8, minInterval:I
    iget-object v11, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    invoke-virtual {v11}, Lcom/android/internal/os/CommonHistoryTimeline;->getLastItem()Lcom/android/internal/os/CommonHistoryItem;

    move-result-object v7

    .line 4547
    .local v7, lastItem:Lcom/android/internal/os/CommonHistoryItem;
    ...
    invoke-virtual {v7}, Lcom/android/internal/os/CommonHistoryItem;->getTime()J
    ...
    invoke-virtual {v7}, Lcom/android/internal/os/CommonHistoryItem;->getValue()J
    ...
    invoke-virtual {v11, v5, v6, v12, v13}, Lcom/android/internal/os/CommonHistoryTimeline;->addHistoryRecord(JJ)V
...
.method public startIteratingHistoryLocked()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->startIteratingHistoryLocked()Z
...
.method writeHistory(Landroid/os/Parcel;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/os/BatteryStatsImpl$HistoryTimeline;->writeHistory(Landroid/os/Parcel;)V

    .line 5027
    iget-object v0, p0, Lcom/android/internal/os/BatteryStatsImpl;->mCurrentValueHistory:Lcom/android/internal/os/CommonHistoryTimeline;

    invoke-virtual {v0, p1}, Lcom/android/internal/os/CommonHistoryTimeline;->writeHistory(Landroid/os/Parcel;)V
