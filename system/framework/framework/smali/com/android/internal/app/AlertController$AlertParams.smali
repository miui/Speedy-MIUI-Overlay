...
.field public mBorderColorIndicator:Landroid/app/AlertDialog$Indicator;
...
.field public mForceUseLongMsgStyle:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 760
    iput-boolean v1, p0, Lcom/android/internal/app/AlertController$AlertParams;->mForceUseLongMsgStyle:Z

    .line 764
    sget-object v0, Landroid/app/AlertDialog$Indicator;->Common:Landroid/app/AlertDialog$Indicator;

    iput-object v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mBorderColorIndicator:Landroid/app/AlertDialog$Indicator;

    .line 768
    const/16 v0, 0x30

    iput v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mGravity:I
...
.method private createListView(Lcom/android/internal/app/AlertController;)V
    ...
    .line 917
    :cond_0
    new-instance v1, Lcom/android/internal/widget/RoundCornerListAdapter;

    invoke-direct {v1, v0}, Lcom/android/internal/widget/RoundCornerListAdapter;-><init>(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/internal/app/AlertController$AlertParams$5;-><init>(Lcom/android/internal/app/AlertController$AlertParams;Lcom/android/internal/app/AlertController;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/internal/app/AlertController$AlertParams$2;-><init>(Lcom/android/internal/app/AlertController$AlertParams;Landroid/content/Context;Landroid/database/Cursor;ZLcom/android/internal/app/AlertController$RecycleListView;)V
    ...
    :cond_6
    iget-boolean v1, p0, Lcom/android/internal/app/AlertController$AlertParams;->mIsContextMenu:Z
    ...
    :cond_8
    new-instance v7, Lcom/android/internal/app/AlertController$AlertParams$3;

    iget-object v9, p0, Lcom/android/internal/app/AlertController$AlertParams;->mContext:Landroid/content/Context;

    const v11, 0x1020014

    iget-object v12, p0, Lcom/android/internal/app/AlertController$AlertParams;->mItems:[Ljava/lang/CharSequence;

    move-object v8, p0

    invoke-direct/range {v7 .. v12}, Lcom/android/internal/app/AlertController$AlertParams$3;-><init>(Lcom/android/internal/app/AlertController$AlertParams;Landroid/content/Context;II[Ljava/lang/CharSequence;)V
    ...
    invoke-direct/range {v7 .. v13}, Lcom/android/internal/app/AlertController$AlertParams$4;-><init>(Lcom/android/internal/app/AlertController$AlertParams;Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[I)V
    ...
    .line 930
    new-instance v1, Lcom/android/internal/app/AlertController$AlertParams$6;

    invoke-direct {v1, p0, v6, p1}, Lcom/android/internal/app/AlertController$AlertParams$6;-><init>(Lcom/android/internal/app/AlertController$AlertParams;Lcom/android/internal/app/AlertController$RecycleListView;Lcom/android/internal/app/AlertController;)V
...
.method public apply(Lcom/android/internal/app/AlertController;)V
    ...
    .line 798
    :goto_0
    iget-boolean v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mIsContextMenu:Z

    invoke-virtual {p1, v0}, Lcom/android/internal/app/AlertController;->setIsContextMenu(Z)V
    ...
    .line 816
    invoke-virtual {p1, v4}, Lcom/android/internal/app/AlertController;->setInverseBackgroundForced(Z)V

    .line 818
    :cond_4
    iget-boolean v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mForceUseLongMsgStyle:Z

    if-eqz v0, :cond_5

    .line 819
    invoke-virtual {p1, v4}, Lcom/android/internal/app/AlertController;->setUseLongMsgStyleForced(Z)V
    ...
    :cond_8
    :goto_1
    iget-object v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mBorderColorIndicator:Landroid/app/AlertDialog$Indicator;

    invoke-virtual {p1, v0}, Lcom/android/internal/app/AlertController;->setIndicator(Landroid/app/AlertDialog$Indicator;)V

    .line 836
    iget v0, p0, Lcom/android/internal/app/AlertController$AlertParams;->mGravity:I

    invoke-virtual {p1, v0}, Lcom/android/internal/app/AlertController;->setGravity(I)V
